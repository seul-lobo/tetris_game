...
void main() async {
  ...
  await Hive.openBox('gameStats'); // For game history and statistics
  await Hive.openBox('settings'); // For future settings/preferences
  await Hive.openBox('achievements'); // For achievement tracking
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        fontFamily: 'Roboto',
        useMaterial3: true,
        //Custom theme for better consistency
